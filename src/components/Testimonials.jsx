...
export default function Testimonials() {
    return (
        <div id='testimonials' className='mt-20 tracking-wide'>
            <h3 className="text-3xl sm:text-5xl lg:text-6xl text-center my-10 lg:my-20">What people are saying</h3>
            <div className="flex flex-wrap justify-center">
                {
                    testimonials.map((testimonial, index) => (
                        <div key={index} className='w-full sm:w-/2 lg:w-1/3 px-4 py-2'>
